...
pygame.display.set_caption("Little Caterpillar")

# Load the player image
player_image = pygame.image.load("caterpillar.png")
...
# Load the item image
item_image = pygame.image.load("apple.png")
...
button_text = button_font.render("New Game", True, (0, 0, 0))
...
while running:
    ...
    # Draw the score
    score_text = font.render("Score: " + str(score) + '00', True, (255, 0, 0))
